...
// ── LAYOUT ──
function hdr(title,date,time){return `<tr><td style="padding-bottom:4px"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td width="140" height="120" class="bg-b header-accent-left" style="border:4px solid ${B}!important"></td><td class="header-body" style="background-color:#fff!important;border:4px solid ${B}!important;border-left:none;padding:20px 30px;vertical-align:middle"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="header-title" style="${F}font-size:36px;font-weight:bold;color:${B}!important;letter-spacing:-1px">${title}</td></tr><tr><td style="${F}font-size:12px;color:${G}!important;text-transform:uppercase;letter-spacing:2px;padding-top:6px">${date}</td></tr><tr><td style="${F}font-size:12px;color:${G}!important;text-transform:uppercase;letter-spacing:2px;padding-top:2px">${time}</td></tr></table></td><td width="60" class="bg-y header-accent-right" style="border:4px solid ${B}!important;border-left:none"></td></tr></table></td></tr>`}
...
function card(accent,tagHtml,rows){return `<tr><td style="padding:0 0 4px"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td width="6" class="${accent}" style="border:3px solid ${B}!important;border-right:none"></td><td class="card-body-td" style="background-color:#fff!important;border:3px solid ${B}!important;padding:20px 24px">${tagHtml}<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">${rows}</table></td></tr></table></td></tr>`}

function hero(tempF,feelsF,cond,code,hi,lo,accent){return `<tr><td style="padding:0 0 4px"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td width="6" class="${accent}" style="border:3px solid ${B}!important;border-right:none"></td><td class="card-body-td" style="background-color:#fff!important;border:3px solid ${B}!important;padding:28px 24px"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td style="vertical-align:middle"><div style="${F}font-size:76px;font-weight:bold;color:${B}!important;line-height:1;letter-spacing:-3px" class="hero-temp">${tempF}°<span class="hero-temp-unit" style="font-size:40px">F</span></div><div style="${F}font-size:14px;color:${B}!important;padding-top:8px">${I('therm')} Feels like <strong>${feelsF}°F</strong></div><div style="${F}font-size:13px;color:${B}!important;padding-top:4px">${I('arrow')} High ${hi}° / Low ${lo}°</div></td><td style="text-align:right;vertical-align:middle;padding-left:16px"><div style="text-align:right">${condI(code,52)}</div><div style="${F}font-size:18px;font-weight:bold;color:${B}!important;padding-top:10px;text-align:right">${cond}</div></td></tr></table></td></tr></table></td></tr>`}

function hourly(hrs,accent){let c='';for(const h of hrs){c+=`<div class="hourly-item" style="display:inline-block;text-align:center;padding:12px 8px;border-right:1px solid #e8e8e8;vertical-align:top;min-width:72px"><div style="${F}font-size:10px;color:${B};text-transform:uppercase;letter-spacing:1px;font-weight:bold">${h.time}</div><div style="padding:6px 0">${condI(h.code,20)}</div><div style="${F}font-size:18px;font-weight:bold;color:${B}">${h.temp}°</div><div style="${F}font-size:11px;color:${B};padding-top:4px">Feels ${h.feels}°</div><div style="${F}font-size:11px;color:${B};padding-top:2px">${I('drop',12)} ${h.precip}%</div><div style="${F}font-size:11px;color:${B};padding-top:2px">${I('wind',12)} ${h.wind} mph</div><div style="${F}font-size:11px;color:${G};padding-top:2px">${I('cloud',12)} ${h.clouds}%</div></div>`}
return `<tr><td style="padding:0 0 4px"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="table-layout:fixed"><tr><td width="6" class="${accent}" style="border:3px solid ${B}!important;border-right:none"></td><td class="card-body-td" style="background-color:#fff!important;border:3px solid ${B}!important;padding:16px 10px;max-width:0;overflow:hidden">${tag(IW('clock')+' Hourly Forecast')}<div style="overflow-x:auto;overflow-y:hidden;white-space:nowrap;margin-top:14px;padding-bottom:8px;-webkit-overflow-scrolling:touch">${c}</div></td></tr></table></td></tr>`}
...
function footer(){return `<tr><td style="padding-top:16px"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td width="50" height="50" class="bg-y footer-accent" style="border:4px solid ${B}!important"></td><td style="background-color:#fff!important;border:4px solid ${B}!important;border-left:none;padding:14px 20px;vertical-align:middle"><span style="${F}font-size:11px;color:#888!important;text-transform:uppercase;letter-spacing:1px">Weather Brief</span></td><td width="50" class="bg-r footer-accent" style="border:4px solid ${B}!important;border-left:none"></td><td width="30" class="bg-b footer-accent" style="border:4px solid ${B}!important;border-left:none"></td></tr></table></td></tr>`}
...
async function build(w,loc,alerts){
    ...
    o+=stats(`${IW('map')} ${locStr.toUpperCase()}`,``);
